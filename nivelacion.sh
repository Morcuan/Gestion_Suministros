...
COMMIT_MSG="Nivelaccion manual, Listas de contratos corregidas en todos los modulos
probadas y funcionando. Estructura de modulos para historico de contratos. $(date '+%Y-%m-%d %H:%M')"
