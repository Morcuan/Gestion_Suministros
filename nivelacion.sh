...
if [ $HAY_CAMBIOS_STAGING -eq 1 ]; then
    COMMIT_MSG="Nivelaccion manual: Rama facturas -> nueva factura terminada a 99.5%.
    Falta corregir estructuralmente el id_factura de las tablas factura. $(date '+%Y-%m-%d %H:%M')"
