...
if [ $HAY_CAMBIOS_STAGING -eq 1 ]; then
    COMMIT_MSG="Nivelaccion manual: Rama historico de contratos terminada a falta de
    pequeños ajustes de informacion en la lista de suplementos.$(date '+%Y-%m-%d %H:%M')"
